import pandas as pd
import os
lista_input=['csv/f1_search/search6both_555.csv','csv/f1_search/search6both_123.csv','csv/f1_search/search6flip_555.csv','csv/f1_search/search6flip_123.csv','csv/f1_search/search6noise_555.csv','csv/f1_search/search6noise_123.csv']
for input_csv in lista_input:
    # Percorsi dei file
    output_csv = input_csv+'_sorted.csv'
